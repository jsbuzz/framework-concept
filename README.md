...
## Based on FlightJS
Using the orininal drive behind FlightJS: to create a non-restrictive, highly scalable and maintainable code that is a strong base for your applications.
